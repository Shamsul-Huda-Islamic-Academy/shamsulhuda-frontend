...
<div className="flex flex-col md:flex-row items-baseline justify-center w-full h-fit mx-8 md:mx-0 my-4">
    <div className="flex flex-col md:h-44 md:flex-row items-center justify-between gap-10 bg-[#18e13d] rounded-lg shadow-md px-6 py-8 w-80 md:w-fit">
        ...
        <div className="flex items-center gap-3">
            ...
            <div>
                <h2 className="font-bold text-white text-4xl gap-2">300+</h2>
        ...
        <div className="flex items-center gap-3">
            ...
            <div>
                <h2 className="font-bold text-white text-4xl gap-2">20+</h2>
        ...
        <div className="flex items-center gap-3">
            ...
            <div>
                <h2 className="font-bold text-white text-4xl gap-2">10+</h2>
        ...
        <div className="flex items-center gap-3">
            ...
            <div>
                <h2 className="font-bold text-white text-4xl gap-2">10000+</h2>
